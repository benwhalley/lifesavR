...
2. Pipe the `fuel` dataset into `head()` and assign the results to a variable called `fuel_head`.
3. Use `fuel_head` to answer the question in the worksheet.
...
1. Upload
[https://raw.githubusercontent.com/benwhalley/lifesavR/main/website/data/world-happiness-report-2021.csv](https://raw.githubusercontent.com/benwhalley/lifesavR/main/website/data/world-happiness-report-2021.csv) to the R Studio server.
2. Create a new chunk which reads `world-happiness-report-2021.csv` into a variable with a descriptive name.
3. Use this variable to answer the question in the worksheet.
...
4. Use the results to answer the question in the worksheet.
...
2. Ensure that the **Environment** pane is empty
