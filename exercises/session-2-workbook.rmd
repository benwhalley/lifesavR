---
title: "lifesavR Session 2 Workbook"
...
This RMarkdown document is your workbook for session two of the lifesavR module.

Note: the chunk above will give an error until you replace the `...` with the name of a package
(e.g. `tidyverse`), so the workbook won't knit until you do this.
...
Amend the code in Exercise 7 to also calculate the mean and standard deviation of `weight`.
...
Note: this chunk contains deliberate errors, so the workbook won't knit until you have fixed them all.
