---
title: "lifesavR Session 3 Workbook"
...
This RMarkdown document is your workbook for session three of the lifesavR course.
...
`funimagery` dataset. (This chunk will give an error until you have replaced every `?`.)
