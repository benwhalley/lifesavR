...
Make a scatterplot of the `fuel` dataset, showing `mpg` on the y-axis, engine size on the x-axis, with coloured points based on transmission type (automatic or manual).

Which type of car (auto or manal) sees the strongest relationship between engine size and fuel economy?

## Extension exercise 3

Use the `development` dataset to make a boxplot showing life expectancy by continent for years greater than 1999.

## Extension exercise 4

Try to recreate the plot shown in the worksheet, using the `mtcars` built-in dataset.
