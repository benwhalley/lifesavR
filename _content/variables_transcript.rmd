...
And we now have a variable called `current_year` which contains the number `2001`
...
Double-clicking on any variable there will show you what is stored inside the container.

[show clicking on the Environment]
