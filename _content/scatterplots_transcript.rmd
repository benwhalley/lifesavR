...
The `%>%` symbol is special, it's called into a pipe. We'll explan more later, but for now just know
...
[SPEAKER SELECTS X AXIS AND Y AXIS IN TURN WHEN DESCRIBING]
