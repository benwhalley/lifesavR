...
- Make sure you can see the `.rmd` file you are working on in the **Files** pane. This means you are "in" the same folder as the `.rmd` (R calls this your *working directory*)
...
In your workbook file (`session-2.rmd`) create a new code chunk (the keyboard shortcut is `Ctrl/Cmd + Alt + I`).
