...
Sometimes dataset can be very large. We often want to work with a subset of all the data, and `filter` makes this possible.
...
This code filters only European countries, and only data after 1980.
...
[DEMONSTRATE EXPLORING THE SUBSET OF DATA, AND HOW IT APPEARS IN THE ENVIRONMENT PANE]
