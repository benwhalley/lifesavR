...
<button class="tablink" data-clipboard-text="#{{identifier}}-summary-tab">
Copy link
</button>
...
<button class="tablink" data-clipboard-text="#{{identifier}}-examples-tab">
Copy link
</button>
...
<button class="tablink" data-clipboard-text="#{{identifier}}-transcript-tab">
Copy link
</button>
