...
The transcript for this video is not available, but the content is largely identical to the next few
...
::: {#evalmodels-transcript .tab-pane}
...
Several authors, inculding Kass & Raftery (1993), have provided guidelines on
how to interpret Bayes Factors in this way. They provide labels for Bayes
Factors of various sizes. This is a more detailed guide than a simple "line in a
sand" and can prove very useful when comparing multiple studies.



```{r bayes-factor-table, echo = FALSE, warning = FALSE, message = FALSE}
# borrowed from https://github.com/ajwills72/rminr/commit/4fd9ca33d7e51cfe9249e864eea064c79d4b5288
library(viridis)
library(gt) 

bf <- read_csv("https://raw.githubusercontent.com/ajwills72/rminr/2022-edition/src/bayes_factors.csv") %>% 
  head(5)
bf_table <- gt(bf)
kk <- viridis(nrow(bf), option = "B", begin = 0.3, end = 1, direction = -1)
...
Note that Bayes Factors can also be smaller than 1, but these indicate support for the 
...
BF we are reporting indicates the support ***for*** the ***null*** hypotheses.
