...
So it's a really powerful tool and we introduce it here. And we'll use it more throughout the course. RMarkdown is a file format and it combines our code with regular text. 

So that means rmarkdown can combine data analysis and graphs with explanatory text, and that makes it easier to communicate with other people.
...
Once the document is ready there is an extra step called 'knitting' in
