...
:::{#bayes-fluke-transcript .tab-pane .fade}
...
:::{#doitbayesianttest-transcript .tab-pane .fade}
...
Specifically, the Bayes Factor from a Bayesian t-test says how probable it is that two groups have a
*different average score* for a *continuous variable*. This probability is *relative* to an
alternative hypothesis that the average of each group is actually the same.
...
:::{#bayes-corr-transcript .tab-pane .fade}
