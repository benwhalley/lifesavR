---
title: 'lifesavR 2026'
author: 'Ben Whalley, Chris Berry, Sonja Heintz, Paul Sharpe, Andy Wills, Julien Besle'
# date: "September 2026"
...
<meta property="og:description" content="lifesavR is a short course in statistics and data visualisation using R." />

**lifesavR is a short course in statistics and data visualisation using R.**
...
-   *Support each other*, but make sure *you* are doing the work too. It's nice to work as a pair or
    a group, and it can be great for your own learning to explain techniques to others. But it's
...
If you are taking this course at the University of Plymouth, the easiest way to run the code examples here
is to use the [school's RStudio Server](https://psyrstudio.plymouth.ac.uk).

Unless you already have a lot of experience with R, don't try to install it on your own computer. We
find this creates unnecessary problems for students. Staff can only help you debug problems
that also happen on the school RStudio server.
...
-   [Bayes Factor](session-5.html#fluke){#bf} quantifies evidence for differences or correlations in
    a dataset
    -   [interpreting](session-5.html#interpretbayesfactors1)
    -   [for multiple regression](session-7.html#strengthofevidenceforlm)
...
-   [`lmBF`](session-7.html#strengthofevidenceforlm) to calculate a Bayes Factor for two linear
    models. Also see [Bayes Factor](#bf)
...
Andy Wills hosts a helpful guide to common errors students face here: <https://www.andywills.info/rminr/common-errors.html>
