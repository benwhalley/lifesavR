...
:::{.tip}
If you're using Windows or an older Mac we strongly recommend [downloading Chrome](https://www.google.co.uk/chrome/) and using that.  If you have any issues with RStudio this is likely the first suggestion we will make.
