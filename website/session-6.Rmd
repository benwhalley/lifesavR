...
- Check 3 key assumptions of your model
...
- Explanation of the regression equation (it describes a straight line)
- Residuals as the divergence from the fitted line
...
1. Recreate the plot  in the video with `screen_time` and the predictor, `anxiety_score` as the outcome, and with the line of best fit (using `geom_smooth` and `geom_point`)
