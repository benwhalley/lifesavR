...
```{r, echo=F}
video_data <- list(identifier = "boxplot-introduction", yt_id = "2FXgGkfXtXw")
# makermds(video_data)
```
...
```{r, echo=F}
video_data <- list(identifier = "scatterplot-colour", yt_id = "wzjGY-Yn2g8")
# makermds(video_data)
```
...
```{r, echo=F}
video_data <- list(identifier = "types-scales", yt_id="RrIRNof4mzM")
# makermds(video_data)
```
...
```{r, echo=F}
video_data <- list(identifier = "group-by", yt_id = "dBfkA3-j3dU")
# makermds(video_data)
```
