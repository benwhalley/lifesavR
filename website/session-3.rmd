...
:::{#makingboxplotstabs-transcript .tab-pane .fade}
...
:::{#scatterplotcolortabs-transcript .tab-pane .fade}
...
on which wheels are driven the engine. An `f` in `drv` means a front wheel drive car, `r` means rear
...
:::{#typesscalestabs-transcript .tab-pane .fade}
```{=html}
<!--
...
:::{#groupbytabs-transcript .tab-pane .fade}
