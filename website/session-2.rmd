...
```{r, echo=F}
video_data <- list(identifier = "fixing-code", ytidentifier = "yt-embed", showcode = T)
#makermds(video_data)
```
...
1. When the code is working, save your workbook
1. Select `Session > Quit Session...`, then close the tab.
