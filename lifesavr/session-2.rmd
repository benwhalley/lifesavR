...
## Which command is used to load data and what are the two places that data can be loaded from?
...
## Which commands would you use to calculate the mean of a numeric column?
