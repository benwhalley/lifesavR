...
1. Use `fuel_head` to answer the question in the workbook.
...
1. Use this variable to answer the question in the workbook.
...
1. Use the results to answer the question in the workbook.
