...
If you're reading this, then you have successfully run the command which installs all of the files required for this module. The command you ran

- Created a directory called `lifesavr` in your `Home` directory

- Installed some R Markdown files. These have the file extension `.rmd`. You will store your work in one of these files in each session. For example, in session one you will only need to edit `session-1.rmd`.

- Downloaded the data used in the module into the `lifesavr/data` folder.

:::{.exercise}

Check that you have all of the files listed above by comparing your **Files** pane in RStudio with the image below.
