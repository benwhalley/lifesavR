...
- R Studio has lots of different ways to explore datasets. We recommend 3 for the moment:
- the `head()` function, which shows the first 6 rows of a dataset
- using the Environment pane, which shows the dataset in a spreadsheet-like view
- `glimpse()`, which shows a list of all the columns in a dataset (useful when there are many columns)
...
1. How to you run part of an R command?
