...
1. Place your cursor (anywhere) on the line that says `library(tidyverse)` (this is explained in the next section)
...
1. Which function says which columns of data should be used in the plot?
