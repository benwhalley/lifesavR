---
title: 'Title TODO... Waving not drowning?!'
...
# histogram plot of some random numbers 
hist(rnorm(100, 0,1))
```
...
- Anything outside a chunk is narrative text.
...
Running part of your code allows you to identify the steps which are correct. This allows you to modify subsequent steps
until your code produces the required results. Remember this technique as you will be using it extensively in these
workshops.
