...
This chunk plots cylinders against highway miles per gallon but jitters the points on the scatter plot, so the plot is
easier to read.
...
Adding color. Explain `aes`. This works:
