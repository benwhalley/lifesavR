...
1. Create a new chunk at the bottom of your worksheet XXX IS THIS NEEDED? PERHAPS PRE-MAKE THIS CHUNK?
1. Create a scatterplot with `gdp_per_capita` on the x-axis (along the bottom) and
  `life_expectancy` on the y-axis
1. Add color to this scatterplot: make each `continent` a different colour.
