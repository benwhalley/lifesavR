...
## FIXME: remove this when Ben resolves missing weight_lost_end_trt
funimagery <- funimagery %>% mutate(weight_lost_end_trt = weight_lost)
```
...
them on graphs. In this workshop we learn to how to use categorical variables in boxplots, to colour scatterplots, and
