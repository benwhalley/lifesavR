...
For example, given questions like this we can find answers in the data:
  ...
  *Q: What is the average life expectancy across all countries in the `development` data?*
...
*Q: Which group lost most weight in the FIT trials*?
...
The point to make here is that we can learn a lot by just describing the differences between groups — either with descriptive *statistics* like means and standard deviations or --- often better --- by visualising the data.
