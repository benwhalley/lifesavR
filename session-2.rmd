...
1. What is the `%>%` symbol called and what does it do?
1. Which command is used to load data and what are the two places that data can be loaded from?
...
1. Which commands would you use to calculate the mean of a numeric column?
