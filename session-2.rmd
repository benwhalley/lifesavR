...
XXX todo - have removed the hitchikers reference to make it simpler XXX
...
- The result is a data frame which can be stored in a variable.
...
1. What is the `%>%` symbol called and what does it do?
1. Which function is used to load data and what are two places that data can be loaded from?
